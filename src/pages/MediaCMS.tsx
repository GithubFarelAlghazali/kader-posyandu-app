      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
        <div>
          ...
          <p className="text-on-surface text-body-md font-bold opacity-60 uppercase tracking-widest leading-relaxed">
            Manage and distribute clinical health resources.
          </p>
        </div>
        ...
        {mediaData.map((item) => (
          ...
          >
            ...
            <div className="p-8 flex flex-col flex-grow">
              <h3 className="text-title-sm font-black text-on-surface leading-tight mb-3 line-clamp-2 min-h-[56px] group-hover:text-primary transition-colors">
                {item.title}
              </h3>
              <p className="text-label-sm text-on-surface font-bold opacity-50 line-clamp-2 mb-8 leading-relaxed max-w-[90%]">
                {item.description}
              </p>
              
              <div className="mt-auto flex items-center justify-between border-t border-outline-variant/10 pt-6">
                <span className="bg-primary text-on-primary px-3 py-1 rounded-lg text-[9px] font-black uppercase tracking-widest shadow-sm">
                  {item.category}
                </span>
